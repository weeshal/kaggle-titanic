...
new_train_df = train_df.loc[:,['Pclass','Sex','Age','Parch']]
new_test_df = test_df.loc[:,['Pclass','Sex','Age','Parch']]

new_train_df['Sex'].replace('male', 1, inplace=True)
new_train_df['Sex'].replace('female', 0, inplace=True)

new_train_df.loc[new_train_df.isna[new_train_df['Age']]==True]=0

print new_train_df['Age']
